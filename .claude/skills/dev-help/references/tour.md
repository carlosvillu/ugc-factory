...
5. **REVIEW** — code-review del diff con esfuerzo proporcional al riesgo (low para diffs mecánicos, medium por defecto, high en orquestador/dinero/seguridad). Hallazgos de correctness → al implementer; se re-gatea tras el fix.
