...
2. **Baby steps dentro de la tarea.** Sigue las Subtareas del planning en orden; el sistema nunca queda a medias.
...
4. **Verifica en local mientras avanzas**: suites del paquete tocado, `pnpm typecheck`, `pnpm lint`. Entrega solo con todo en verde.
