...
3. **Los tests nacen con el código** (skill testing, principio 2): cada comportamiento prometido en la Entrega tiene al menos un test que fallaría si se rompiera, en la capa que dicta la tabla de decisión de testing.
