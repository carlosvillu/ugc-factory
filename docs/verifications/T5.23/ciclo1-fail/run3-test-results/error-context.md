...
Locator: getByRole('complementary', { name: /\bN7d\b/ })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByRole('complementary', { name: /\bN7d\b/ })
    ...
    - list:
      ...
      - listitem:
        - link "Ajustes":
          - /url: /settings
- banner:
  - text: /runs/01KYMTRNFE4N9W0898K2HQ96EC · full
  - heading "Run HQ96EC" [level=1]
  - text: Autopilot
...
- application:
  - img:
    - group "Edge from 01KYMTRNDRCBDA2MNAM5GPQQXV to n7-group-01KYMTRMXQSAXP3DH480KSH8BB"
  - img:
    - group "Edge from 01KYMTRNDRCBDA2MNAM5GPQQXV to 01KYMTRNDY7A36GWFJVE12JQ96"
  - img:
    - group "Edge from n7-group-01KYMTRMXQSAXP3DH480KSH8BB to 01KYMTRNDY7A36GWFJVE12JQ96"
  - img:
    - group "Edge from 01KYMTRNDY7A36GWFJVE12JQ96 to 01KYMTRNDZTF17PZRRSEXBADJE"
  - img:
    - group "Edge from 01KYMTRNE04HQVT1MD4B1B39FZ to n7-group-01KYMTRMXQDWNWKRZQNY03YW0V"
  - img:
    - group "Edge from 01KYMTRNE04HQVT1MD4B1B39FZ to 01KYMTRNE64WAQECNPYMQ4HFEB"
  - img:
    - group "Edge from n7-group-01KYMTRMXQDWNWKRZQNY03YW0V to 01KYMTRNE64WAQECNPYMQ4HFEB"
  - img:
    - group "Edge from 01KYMTRNE64WAQECNPYMQ4HFEB to 01KYMTRNE7TTPJVKQCRQY7JX7J"
  - img:
    - group "Edge from 01KYMTRNE83FDB4J768XNJQX13 to n7-group-01KYMTRMXRAYX92MS590812R9S"
  - img:
    - group "Edge from 01KYMTRNE83FDB4J768XNJQX13 to 01KYMTRNEFBEEBS800VBGE9B4V"
  - img:
    - group "Edge from n7-group-01KYMTRMXRAYX92MS590812R9S to 01KYMTRNEFBEEBS800VBGE9B4V"
  - img:
    - group "Edge from 01KYMTRNEFBEEBS800VBGE9B4V to 01KYMTRNEG02JQ4JNKHBCTKFZ1"
  - img:
    - group "Edge from 01KYMTRNEHDMEQG7DYVREM5SXS to 01KYMTRNEJK723G2V3QTWB1QPW"
  - img:
    - group "Edge from 01KYMTRNEHDMEQG7DYVREM5SXS to 01KYMTRNEJWJYQTZR2RRQYC7MF"
  - img:
    - group "Edge from 01KYMTRNEHDMEQG7DYVREM5SXS to 01KYMTRNEK86CEDAQT08VGQ1W8"
  - img:
    - group "Edge from 01KYMTRNEJWJYQTZR2RRQYC7MF to 01KYMTRNEK86CEDAQT08VGQ1W8"
  - img:
    - group "Edge from 01KYMTRNEHDMEQG7DYVREM5SXS to 01KYMTRNEMP74K5EJXZQ3ZZ4JK"
  - img:
    - group "Edge from 01KYMTRNEJK723G2V3QTWB1QPW to 01KYMTRNEMP74K5EJXZQ3ZZ4JK"
  - img:
    - group "Edge from 01KYMTRNEJWJYQTZR2RRQYC7MF to 01KYMTRNEMP74K5EJXZQ3ZZ4JK"
  - img:
    - group "Edge from 01KYMTRNEHDMEQG7DYVREM5SXS to 01KYMTRNENMV4AYZ905EYE3KHY"
  - img:
    - group "Edge from 01KYMTRNEJK723G2V3QTWB1QPW to 01KYMTRNENMV4AYZ905EYE3KHY"
  - img:
    - group "Edge from 01KYMTRNEJWJYQTZR2RRQYC7MF to 01KYMTRNENMV4AYZ905EYE3KHY"
  - img:
    - group "Edge from 01KYMTRNEHDMEQG7DYVREM5SXS to 01KYMTRNEVGP21761TJW6QBQH0"
  - img:
    - group "Edge from 01KYMTRNEHDMEQG7DYVREM5SXS to 01KYMTRNEWTZ2S8W3JMJ9GMAK1"
  - img:
    - group "Edge from 01KYMTRNEJWJYQTZR2RRQYC7MF to 01KYMTRNEWTZ2S8W3JMJ9GMAK1"
  - img:
    - group "Edge from 01KYMTRNEK86CEDAQT08VGQ1W8 to 01KYMTRNEWTZ2S8W3JMJ9GMAK1"
  - img:
    - group "Edge from 01KYMTRNEMP74K5EJXZQ3ZZ4JK to 01KYMTRNEWTZ2S8W3JMJ9GMAK1"
  - img:
    - group "Edge from 01KYMTRNENMV4AYZ905EYE3KHY to 01KYMTRNEWTZ2S8W3JMJ9GMAK1"
  - img:
    - group "Edge from 01KYMTRNEVGP21761TJW6QBQH0 to 01KYMTRNEWTZ2S8W3JMJ9GMAK1"
  - img:
    - group "Edge from 01KYMTRNEWTZ2S8W3JMJ9GMAK1 to 01KYMTRNEXV0H9H297265YEYBV"
  - img:
    - group "Edge from 01KYMTRNEY51ARPQZEEANCRC8W to n7-group-01KYMTRMXSP6GQ86TB9TESHACD"
  - img:
    - group "Edge from 01KYMTRNEY51ARPQZEEANCRC8W to 01KYMTRNF4YGJRXJDKWQJD5K2T"
  - img:
    - group "Edge from n7-group-01KYMTRMXSP6GQ86TB9TESHACD to 01KYMTRNF4YGJRXJDKWQJD5K2T"
  - img:
    - group "Edge from 01KYMTRNF4YGJRXJDKWQJD5K2T to 01KYMTRNF5WMYAACSTVRPDHKWH"
  - img:
    - group "Edge from 01KYMTRNF6SRNBXR6RR67DQWB7 to n7-group-01KYMTRMXTTGAJ51WZC0BHQCF2"
  - img:
    - group "Edge from 01KYMTRNF6SRNBXR6RR67DQWB7 to 01KYMTRNFCJ1581KH226EJTYZ7"
  - img:
    - group "Edge from n7-group-01KYMTRMXTTGAJ51WZC0BHQCF2 to 01KYMTRNFCJ1581KH226EJTYZ7"
  - img:
    - group "Edge from 01KYMTRNFCJ1581KH226EJTYZ7 to 01KYMTRNFDKQV3B7FKPNPJQTD5"
  - group:
    - article "N6 completado":
      - text: N6 Compilación de prompts completado
      - paragraph: "{\"node\":\"N6\",\"variantId\":\"01KYMTRMXQSAXP3DH480KSH8BB\",\"templateSlug\":\"demo-pain-point\",\"resolvedBeats\":[{\"tEnd\":3,\"action\":\"pain-point hook\",\"camera\":\"fixed on shelf\",\"tStart\":0,\"dialogue\":\"Mira esto"
      - text: 28ms $0.00
  - group:
  ...
  - group:
    - article "N6 completado":
      - text: N6 Compilación de prompts completado
      - paragraph: "{\"node\":\"N6\",\"variantId\":\"01KYMTRMXQDWNWKRZQNY03YW0V\",\"templateSlug\":\"demo-pain-point\",\"resolvedBeats\":[{\"tEnd\":3,\"action\":\"pain-point hook\",\"camera\":\"fixed on shelf\",\"tStart\":0,\"dialogue\":\"Mira esto"
      - text: 12ms $0.00
  - group:
    - article "N8 completado":
      - text: N8 Composición completado
  ...
  - group:
    - article "N6 completado":
      - text: N6 Compilación de prompts completado
      - paragraph: "{\"node\":\"N6\",\"variantId\":\"01KYMTRMXRAYX92MS590812R9S\",\"templateSlug\":\"demo-pain-point\",\"resolvedBeats\":[{\"tEnd\":3,\"action\":\"pain-point hook\",\"camera\":\"fixed on shelf\",\"tStart\":0,\"dialogue\":\"Mira esto"
      - text: 13ms $0.00
  - group:
    - article "N8 completado":
      - text: N8 Composición completado
  ...
  - group:
    - article "N6 completado":
      - text: N6 Compilación de prompts completado
      - paragraph: "{\"node\":\"N6\",\"variantId\":\"01KYMTRMXRNSYX88M3XTKCDZPA\",\"templateSlug\":\"demo-pain-point\",\"resolvedBeats\":[{\"tEnd\":3,\"action\":\"pain-point hook\",\"camera\":\"fixed on shelf\",\"tStart\":0,\"dialogue\":\"Mira esto"
      - text: 20ms $0.00
  - group:
    - article "N8 completado":
      - text: N8 Composición completado
  ...
  - group:
    - article "N6 completado":
      - text: N6 Compilación de prompts completado
      - paragraph: "{\"node\":\"N6\",\"variantId\":\"01KYMTRMXSP6GQ86TB9TESHACD\",\"templateSlug\":\"demo-pain-point\",\"resolvedBeats\":[{\"tEnd\":3,\"action\":\"pain-point hook\",\"camera\":\"fixed on shelf\",\"tStart\":0,\"dialogue\":\"Mira esto"
      - text: 12ms $0.00
  - group:
    - article "N8 completado":
      - text: N8 Composición completado
  ...
  - group:
    - article "N6 completado":
      - text: N6 Compilación de prompts completado
      - paragraph: "{\"node\":\"N6\",\"variantId\":\"01KYMTRMXTTGAJ51WZC0BHQCF2\",\"templateSlug\":\"demo-pain-point\",\"resolvedBeats\":[{\"tEnd\":3,\"action\":\"pain-point hook\",\"camera\":\"fixed on shelf\",\"tStart\":0,\"dialogue\":\"Mira esto"
      - text: 17ms $0.00
  - group:
  ...
  - group:
    - article "01KYMTRMXQSAXP3DH480KSH8BB completado (6 nodos)":
      - text: Variante KSH8BB
      - button "Expandir Variante KSH8BB": +
      - text: Generación de assets 6 sub-pasos
  - group:
    - article "01KYMTRMXQDWNWKRZQNY03YW0V completado (6 nodos)":
      - text: Variante 03YW0V
      - button "Expandir Variante 03YW0V": +
      - text: Generación de assets 6 sub-pasos
  - group:
    - article "01KYMTRMXRAYX92MS590812R9S completado (6 nodos)":
      - text: Variante 812R9S
      - button "Expandir Variante 812R9S": +
      - text: Generación de assets 6 sub-pasos
  - group:
    - article "01KYMTRMXRNSYX88M3XTKCDZPA completado (6 nodos)":
      - text: Variante KCDZPA
      - button "Colapsar Variante KCDZPA" [expanded]: −
      - text: Generación de assets 6 sub-pasos
  - group:
    - article "N7a completado":
      - text: N7a Product shots y keyframes completado
      - paragraph: "{\"route\":\"ai_packshot\",\"shots\":[{\"assetId\":\"01KYMTRP1VSADYC0C9RVR2YVTZ\",\"costCents\":1,\"generationId\":\"01KYMTRP1KSGZ7H73KBH5MFKXK\"},{\"assetId\":\"01KYMTRP25GWH1WMXSSJ2EJKEA\",\"costCents\":1,\"generationId\":"
      - text: 30ms $0.02
  - group:
    - article "N7b completado":
      - text: N7b Voz (TTS) completado
      - paragraph: "{\"clips\":[{\"assetId\":\"01KYMTN1YC4P703E89GE5AD8KV\",\"wordCount\":4,\"sceneIndex\":0,\"asrCostCents\":0,\"generationId\":\"01KYMTN1XHHQ6WF5MV6HWJM4N3\",\"ttsCostCents\":0,\"durationSeconds\":1.8},{\"assetId\":\"01KYMTN1"
      - text: 20ms $0.00
  - group:
    - article "N7c completado":
      - text: N7c Clip de avatar completado
      - paragraph: "{\"assetId\":\"01KYMTN2DZHTW8WG4RK5WTS8VP\",\"costCents\":0,\"generationId\":\"01KYMTN2DNGMPBBM0A8TQC7MPA\",\"avatarEndpoint\":\"fal-ai/bytedance/omnihuman/v1.5\",\"durationSeconds\":5}"
      - text: 31ms $0.00
  - group:
    - article "N7d completado":
      - text: N7d B-roll completado
      - paragraph: "{\"clips\":[{\"assetId\":\"01KYMTRPWT87MR1QZ6JS0RSW6N\",\"clipIndex\":0,\"costCents\":80,\"generationId\":\"01KYMTRPWDW6NK5T7VTE5E9VXW\",\"bodySceneIndex\":0,\"durationSeconds\":4}],\"route\":\"i2v\",\"scriptId\":\"01KYMTRN2N"
      - text: 35ms $0.80
  - group:
    - article "N7f completado":
      - text: N7f N7f completado
      - paragraph: "{\"clips\":[{\"assetId\":\"01KYMTRPWVHVVTCFXHW139B73G\",\"clipIndex\":0,\"costCents\":80,\"generationId\":\"01KYMTRPWG031RP5ATRBQ1V7KC\",\"ctaSceneIndex\":0,\"durationSeconds\":4}],\"route\":\"i2v\",\"scriptId\":\"01KYMTRN2N1"
      - text: 30ms $0.80
  - group:
    - article "N7e completado":
      ...
      - text: 10ms $0.00
  - group:
    - article "01KYMTRMXSP6GQ86TB9TESHACD completado (6 nodos)":
      - text: Variante ESHACD
      - button "Expandir Variante ESHACD": +
      - text: Generación de assets 6 sub-pasos
  - group:
    - article "01KYMTRMXTTGAJ51WZC0BHQCF2 esperando deps (6 nodos)":
      - text: Variante BHQCF2
      - button "Expandir Variante BHQCF2": +
      - text: Generación de assets 6 sub-pasos
  - img
  - button "Acercar":
    - img
...
- complementary:
  ...
  - list:
    - listitem:
      - button "Ángulo 1 serum-hidratante-angulo-1-hook01-01kymtmt8x9y-es-12s-01kymtrmx7e6"
    - listitem:
      - button "Ángulo 1 serum-hidratante-angulo-1-hook02-01kymtmt8x9y-es-12s-01kymtrmx7e6"
    - listitem:
      - button "Ángulo 2 serum-hidratante-angulo-2-hook01-01kymtkx0k3y-es-12s-01kymtrmx7e6"
    - listitem:
      - button "Ángulo 2 serum-hidratante-angulo-2-hook02-01kymtkx0k3y-es-12s-01kymtrmx7e6"
    - listitem:
      - button "Ángulo 3 serum-hidratante-angulo-3-hook01-01kymtkx3yfz-es-12s-01kymtrmx7e6"
- heading "Ángulo 1" [level=2]
- paragraph: serum-hidratante-angulo-1-hook01-01kymtmt8x9y-es-12s-01kymtrmx7e6
- tablist:
...
> 326 |       ).toBeVisible({ timeout: 15_000 });
  ...
  412 |   while (Date.now() < deadline) {
  413 |     const rows = await queryStack<{ run_id: string }>(
  414 |       `SELECT DISTINCT sr.run_id
  415 |          FROM step_run sr
  416 |          JOIN ad_variant v ON v.id = sr.variant_id
  417 |         WHERE v.batch_id = $1 AND sr.node_key = 'N6'
  418 |         LIMIT 1`,
  419 |       [batchId],
  420 |     );
  421 |     if (rows[0]?.run_id !== undefined) return rows[0].run_id;
  422 |     await new Promise((r) => setTimeout(r, 1_000));
  423 |   }
  424 |   return '';
  425 | }
  426 | 
